 ...
 */
@Slf4j
public class ExtendedMarkdownContentHandler extends SafeContentHandler {
     ...
     */
    public static final Set<String> END_LINE =
    ...
    public ExtendedMarkdownContentHandler(ContentHandler handler, Metadata metadata) {
        super(handler);
    ...
    public void endElement(String uri, String local, String name) throws SAXException {
        if (!AUTO.contains(name)) {
            ...
            if (XHTML.equals(uri) && END_LINE.contains(name)) {
                newline();
            }
        }
    }
    ...
    public void element(String name, String value) throws SAXException {
        if (value != null && !value.isEmpty()) {
            log.info("element-name:{},value:{}", name, value);
            startElement(name);
            characters(value);
            endElement(name);
        }
